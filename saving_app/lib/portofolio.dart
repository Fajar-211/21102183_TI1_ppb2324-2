    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          , portofolioCardList(
            'assets/images1.jpeg', 
            'pensions savings funds', 
            0.3, 
            'Rp. 10.430.000 / Rp. 40.000.000', 
            'last saving febuary 19',
            )
          , portofolioCardList(
            'assets/images1.jpeg', 
            'camera', 
...
,
  ...
  Widget portofolioCardList(String icon, String title, double percent, String amount, String time,) {
    return Container(
